...
document.addEventListener("turbolinks:load", () => {
  ...
  $("#purchase_date").on("keyup",dateKeyupCapture); //purchase form
  $("#value_as_of_date").on("keyup",dateKeyupCapture); //value form
  $("#autograph_autograph_date").on("keyup",dateKeyupCapture); //autograph form
  $("#search_purchase_date").on("keyup",dateKeyupCapture); //search page
  $("#search_autograph_date").on("keyup",dateKeyupCapture); //search page
