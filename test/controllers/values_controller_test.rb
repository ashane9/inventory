...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post values_url, params: { value: { as_of_date: @value.as_of_date, estimated_value: @value.estimated_value } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { as_of_date: @value.as_of_date, estimated_value: @value.estimated_value } }
